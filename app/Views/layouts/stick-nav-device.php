<button id="scrollTopBtn"
  class="fixed md:bottom-6 bottom-16 right-6 bg-black h-10 w-10 rounded-full text-white text-xl shadow-lg transition-all duration-300 hover:scale-110 z-40 opacity-0 pointer-events-none translate-y-5">
  <i class="ri-arrow-up-line"></i>
</button>

  <nav   class="shadow-[0_-6px_14px_rgba(0,0,0,0.12)] 
            navbar md:hidden fixed bottom-0 left-0 right-0 
            grid grid-cols-4 items-center bg-white py-3 z-50 text-base w-full">
