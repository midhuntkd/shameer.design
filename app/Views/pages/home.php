  ...
  <div id="smooth-wrapper">
    ...
    <div id="smooth-content">
      ...
      <div class="container mx-auto">
        ...
        $bannerItems = $banners ?? [];
        $bannerBgClasses = ['bg-[#ffffff]', 'bg-[#ffffff]', 'bg-[#ffffff]', 'bg-[#ffffff]'];
            ...
            <div class="swiper-wrapper py-12">
              ...
              <?php if (!empty($bannerItems)): ?>
                ...
                <?php foreach ($bannerItems as $index => $banner): ?>
                  ...
                  <div class="swiper-slide rounded-2xl <?= esc($bgClass, 'attr') ?>">

                    <a href="<?= esc($bannerLink, 'attr') ?>" class="block w-full h-full">
                      <img src="<?= esc($bannerImage, 'attr') ?>" class="w-full rounded-lg " width="1297" height="653"
                        alt="<?= esc($bannerTitle !== '' ? $bannerTitle : 'banner') ?>" />

                      <div style="padding-top:18px">
                        <div class="text-sm pt-2"><?= esc($bannerType) ?></div>
                        <h4 class="text-lg font-normal"> <?= esc($bannerTitle) ?></h4>
                      </div>
                    </a>
                  </div>
        ...
        <div data-aos="fade-up">
          <div
            ...
            <div class="flex-col lg:space-y-20 md:space-y-12 space-y-7 justify-between flex">
              ...
              <div class="discription flex flex-col lg:space-y-20 md:space-y-12 space-y-7 ">
              ...
              <a href="<?= site_url('about') ?>" class="more-btn group "><span>more about
        ...
        <div class="certification lg:pb-28 md:pb-16 pb-3 pt-9 bg-white">
          <div data-aos="fade-up">
            <div class="title flex items-center gap-3 pb-5 md:pb-6 lg:pb-8">
          ...
          <div>
            <a href="https://www.linkedin.com/learning/certificates/85b4fb77d545e09fdc2f59dd61b8190bdc5c48bb92bc19d92584fc25e4b5a2a3"
              target="_blank" class="item no-underline group " data-aos="fade-up">
            ...
            <a href="https://www.linkedin.com/learning/certificates/6514bc3f45e3e1524afbd127ac5b2af307ed950ec8b0177f278d297f5e418ef5"
              target="_blank" class="item no-underline group " data-aos="fade-up">
            ...
            <a href="https://www.linkedin.com/learning/certificates/99dd04040ac2bfeb823e3dab70bfc7d85c238d30d9926c5b7cbc7c59ef099134"
              target="_blank" class="item no-underline group " data-aos="fade-up">
            ...
            <a href="https://www.linkedin.com/learning/certificates/33cab8d26505456f970e05e25b4aa64ee2338eb8351622e230c9e7c1fd65daa5"
              target="_blank" class="item no-underline group " data-aos="fade-up">
